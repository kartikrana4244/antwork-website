      ...
      <motion.section ref={imgRef} {...sectionReveal} className="relative overflow-hidden bg-white py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl">
              <motion.div className="absolute -inset-4" style={{ y: imgY }}>
                <Image src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800" alt="Investment opportunities" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
              </motion.div>
            </motion.div>
          </div>
        </div>
